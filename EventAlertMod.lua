...
function EventAlert_InitArrayConfig()			
	...
	local function init1_2() 
		...
		if EA_Config.AlertSound == nil then EA_Config.AlertSound = 568154 end;
...
function EAFun_CreateVersionFrame_ScrollEditBox()
	...
	if scc == nil then
		...
		--for WOW9.0-----------------------------------------------------------
		Lib_ZYF:SetBackdrop(EA_Version_Frame,{bgFile="Interface/DialogFrame/UI-DialogBox-Gold-Background", 	edgeFile="", tile = false, 	tileSize = 1, edgeSize = 1, insets = { left = 0, right = 0, top = 0, bottom = 0, },})		
		-------------------------------------------------------------
...
local function EAEXF_AnimAlpha(self, fraction)
	...
	if iEAEXF_Prefraction >= fraction + iEAEXF_totalTime/iEAEXF_MaxCount then
		...
		--local extName = "BLP"
		local extName = "TGA"
		Lib_ZYF:SetBackdrop(self,{bgFile = "Interface/AddOns/EventAlertMod/Images/"..extName.."/Seed"..iEAEXF_FrameCount.."."..extName})		
