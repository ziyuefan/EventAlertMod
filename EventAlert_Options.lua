...
function EventAlert_Options_Init()
	...
	Lib_ZYF:SetBackdrop(EA_Options_Frame,{bgFile="interface/dialogframe/ui-dialogbox-gold-background", edgeFile="interface/dialogframe/ui-dialogbox-gold-border", tile = true, 	tileSize = 32, edgeSize = 32, insets = { left = 11, right = 12, top = 11, bottom = 11, },})
	Lib_ZYF:SetBackdropColor(EA_Options_Frame,1,1,1,2/3)
	Lib_ZYF:SetBackdropBorderColor(EA_Options_Frame,1,1,1,1)	

	Lib_ZYF:SetBackdrop(EA_SpellCondition_Frame,{bgFile="interface/dialogframe/ui-dialogbox-background-dark", edgeFile="interface/dialogframe/ui-dialogbox-gold-border", tile = true, 	tileSize = 32, edgeSize = 32, insets = { left = 11, right = 12, top = 11, bottom = 11, },})
	Lib_ZYF:SetBackdropColor(EA_SpellCondition_Frame,1,1,1,2/3)
	Lib_ZYF:SetBackdropBorderColor(EA_SpellCondition_Frame,1,1,1,1)
	
	Lib_ZYF:SetBackdrop(EA_Class_Events_Frame,{bgFile="interface/dialogframe/ui-dialogbox-gold-background", edgeFile="interface/dialogframe/ui-dialogbox-gold-border", tile = true, 	tileSize = 32, edgeSize = 32, insets = { left = 11, right = 12, top = 11, bottom = 11, },})
	Lib_ZYF:SetBackdropColor(EA_Class_Events_Frame,1,1,1,0.5)
	Lib_ZYF:SetBackdropBorderColor(EA_Class_Events_Frame,1,1,1,0.5)	
	
	Lib_ZYF:SetBackdrop(EA_Other_Events_Frame,{bgFile="interface/dialogframe/ui-dialogbox-gold-background", edgeFile="interface/dialogframe/ui-dialogbox-gold-border", tile = true, 	tileSize = 32, edgeSize = 32, insets = { left = 11, right = 12, top = 11, bottom = 11, },})
	Lib_ZYF:SetBackdropColor(EA_Other_Events_Frame,1,1,1,0.5)
	Lib_ZYF:SetBackdropBorderColor(EA_Other_Events_Frame,1,1,1,0.5)
	
	Lib_ZYF:SetBackdrop(EA_Target_Events_Frame,{bgFile="interface/dialogframe/ui-dialogbox-gold-background", edgeFile="interface/dialogframe/ui-dialogbox-gold-border", tile = true, 	tileSize = 32, edgeSize = 32, insets = { left = 11, right = 12, top = 11, bottom = 11, },})
	Lib_ZYF:SetBackdropColor(EA_Target_Events_Frame,1,1,1,0.5)
	Lib_ZYF:SetBackdropBorderColor(EA_Target_Events_Frame,1,1,1,0.5)
	
	Lib_ZYF:SetBackdrop(EA_SCD_Events_Frame,{bgFile="interface/dialogframe/ui-dialogbox-gold-background", edgeFile="interface/dialogframe/ui-dialogbox-gold-border", tile = true, 	tileSize = 32, edgeSize = 32, insets = { left = 11, right = 12, top = 11, bottom = 11, },})
	Lib_ZYF:SetBackdropColor(EA_SCD_Events_Frame,1,1,1,0.5)
	Lib_ZYF:SetBackdropBorderColor(EA_SCD_Events_Frame,1,1,1,0.5)
	
	Lib_ZYF:SetBackdrop(EA_Group_Events_Frame,{bgFile="interface/dialogframe/ui-dialogbox-gold-background", edgeFile="interface/dialogframe/ui-dialogbox-gold-border", tile = true, 	tileSize = 32, edgeSize = 32, insets = { left = 11, right = 12, top = 11, bottom = 11, },})
	Lib_ZYF:SetBackdropColor(EA_Group_Events_Frame,1,1,1,1)
	Lib_ZYF:SetBackdropBorderColor(EA_Group_Events_Frame,1,1,1,1)
	
	Lib_ZYF:SetBackdrop(EA_GroupEventSetting_Frame,{bgFile="interface/dialogframe/ui-dialogbox-background-dark", edgeFile="interface/dialogframe/ui-dialogbox-gold-border", tile = true, 	tileSize = 32, edgeSize = 32, insets = { left = 11, right = 12, top = 11, bottom = 11, },})
